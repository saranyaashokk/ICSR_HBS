...
var StartYear = 2017; //First Year in drop down year selection
...
var CalBgColor = "#fff"; //Background color of Calendar window.
...
function RenderCssCal(bNewCal) {
    ...
    if (Cal.ShowTime === true) {
        ...
        vCalTime = "<tr><td colspan='7' style=\"text-align:center;background-color:white\"><table border='0' width='199px' cellpadding='0' cellspacing='0'><tbody><tr><td height='5px' width='" + HourCellWidth + "'>&nbsp;</td>";

        if (ShowArrows && UseImageFiles) //this is where the up and down arrow control the hour.
        {
            vCalTime += "<td style='vertical-align:middle; background-color:white'><table cellspacing='0' cellpadding='0' style='line-height:0pt;width:100%;'><tr><td style='text-align:center;'><img onclick='nextStep(\"Hour\", \"plus\");' onmousedown='startSpin(\"Hour\", \"plus\");' onmouseup='stopSpin();' src='" + imageFilesPath + "cal_plus.png' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr><tr><td style='text-align:center;'><img onclick='nextStep(\"Hour\", \"minus\");' onmousedown='startSpin(\"Hour\", \"minus\");' onmouseup='stopSpin();' src='" + imageFilesPath + "cal_minus.png' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr></table></td>\n";
        }
        ...
        {
            vCalTime += "</td>\n<td style='vertical-align:middle;background-color:black'><table cellspacing='0' cellpadding='0' style='line-height:0pt;width:100%'><tr><td style='text-align:center;'><img onclick='nextStep(\"Minute\", \"plus\");' onmousedown='startSpin(\"Minute\", \"plus\");' onmouseup='stopSpin();' src='" + imageFilesPath + "cal_plus.png' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr><tr><td style='text-align:center;'><img onmousedown='startSpin(\"Minute\", \"minus\");' onmouseup='stopSpin();' onclick='nextStep(\"Minute\",\"minus\");' src='" + imageFilesPath + "cal_minus.png' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr></table>";
        }

        vCalTime += "</td>\n<td align='right' valign='bottom' width='" + HourCellWidth + "px'></td></tr>";
        vCalTime += "<tr><td></td></tr>";
        vCalTime += "<tr><td colspan='8' style=\"text-align:center;\"><input style='width:60px;background: #d1ded5;        background - image: -webkit - linear - gradient(top, #d1ded5, #718f5d);        background - image: -moz - linear - gradient(top, #d1ded5, #718f5d);        background - image: -ms - linear - gradient(top, #d1ded5, #718f5d);        background - image: -o - linear - gradient(top, #d1ded5, #718f5d);        background - image: linear - gradient(to bottom, #d1ded5, #718f5d);color: #030003;font-size:12px;' onClick='javascript:closewin(\"" + Cal.Ctrl + "\");'  type=\"button\" value=\"OK\">&nbsp;<input style='width:60px;    background: #d1ded5;        background - image: -webkit - linear - gradient(top, #d1ded5, #718f5d);        background - image: -moz - linear - gradient(top, #d1ded5, #718f5d);        background - image: -ms - linear - gradient(top, #d1ded5, #718f5d);        background - image: -o - linear - gradient(top, #d1ded5, #718f5d);        background - image: linear - gradient(to bottom, #d1ded5, #718f5d);color: #030003;font - size: 12px;' onClick='javascript: winCal.style.visibility = \"hidden\"' type=\"button\" value=\"Cancel\"></td></tr>";
    }
